...
namespace ProtonConsole2.Proton
{
    ...
    public abstract class ProtonDbFileReader : IDisposable
    {
        ...
        public static IPrimativeIntConverter IntConverter = new BigEndianIntegerPrimitive();

        public static IPrimativeFloatConverter FloatConverter = new BigEndianFloatPrimative();
        ...
        public static string GetString(ReadOnlyMemory<byte> mem)
        {
            ...
            if (l > 0) { return Encoding.ASCII.GetString(mem.Slice(0, l).Span); }
            return string.Empty;
        }
